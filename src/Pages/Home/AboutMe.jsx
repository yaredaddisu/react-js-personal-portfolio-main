    ...
    <section id="AboutMe" className="about--section">
      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          <p className="text-md">
          I'm Yared Addisu, a passionate software engineer with over three years of experience in the Software Development and Graphics Design. My journey began with a strong foundation in HTML, CSS, and JavaScript, which eventually led me to explore various frameworks and libraries such as Vue.js, React.js, Laravel, and Spring Boot.
          <br />
